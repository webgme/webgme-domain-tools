...
define (['util/sax'], function (sax) {
    "use strict";

    /**
     * Xml2Json converter
     * @param {object} arrayElements - Dictionary where keys evalutated to true are treated as arrays in the generated json.
     * @param {object} options - options.attrTag is prepended to attributes keys, options.textTag is key values for text.
     * @constructor
     */
    var XML2JSON = function (arrayElements, options) {
        var self = this,
            opts = options || {},
            attrTag = opts.attrTag || '_',
