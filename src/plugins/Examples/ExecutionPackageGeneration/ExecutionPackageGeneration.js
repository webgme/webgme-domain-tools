 ...
 * To run from server (webgme-domain-tools are working directory)
 * node node_modules\webgme\bin\run_plugin.js -c config.json -n ExecutionPackageGeneration -p TestCore -j "src/plugins/Examples/ExecutionPackageGeneration/serverConfig.json"
*/
