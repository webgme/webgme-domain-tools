...
define(['js/Widgets/DiagramDesigner/DiagramDesignerWidget.DesignerItems'], function (DiagramDesignerWidgetDesignerItems) {

    "use strict";

    var NetLabelWidgetDesignerItems;

    NetLabelWidgetDesignerItems = function () {
        DiagramDesignerWidgetDesignerItems.call(this);
    };

    _.extend(NetLabelWidgetDesignerItems.prototype, DiagramDesignerWidgetDesignerItems.prototype);

    NetLabelWidgetDesignerItems.prototype.createDesignerItem = function (objD) {
