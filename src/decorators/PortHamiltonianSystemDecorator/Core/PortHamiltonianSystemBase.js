...
define(['js/NodePropertyNames',
    ...
    /**
     * A module representing PortHamiltonianSystemBase decorator functionality for the PortHamiltonianSystemModelingLanguage.
     * @exports PortHamiltonianSystemBase
     * @version 1.0
     */
    var PortHamiltonianSystemBase;

    /**
     * Initializes a new instance of PortHamiltonianSystemBase.
     * @constructor
     */
    PortHamiltonianSystemBase = function () {
     ...
     * @private
     */
    PortHamiltonianSystemBase.prototype._updatePorts = function () {
        var self = this,
            portId,
            len = 4,
            ...
            PortWidth = PortHamiltonianSystemDecoratorConstants.PORT_WIDTH;
        ...
        while (len--) {
            ...
            portId = 3 - len;
            if (portId === 3) {
                connectorE.addClass(PortHamiltonianSystemDecoratorConstants.RIGHT_PORT_CLASS);
            } else if (portId === 2) {
                connectorE.addClass(PortHamiltonianSystemDecoratorConstants.LEFT_PORT_CLASS);
            } else if (portId === 1 || portId === 4 || portId === 5) {
                connectorE.addClass(PortHamiltonianSystemDecoratorConstants.BOTTOM_PORT_CLASS);
            } else {
                connectorE.addClass(PortHamiltonianSystemDecoratorConstants.TOP_PORT_CLASS);
            }
     ...
     * @private
     */
    PortHamiltonianSystemBase.prototype._renderMetaTypeSpecificParts = function () {
     ...
     */
    PortHamiltonianSystemBase.prototype.getConnectionAreas = function (id/*, isEnd, connectionMetaInfo*/) {
        var self = this,
            result = [],
            i,
    ...
    return PortHamiltonianSystemBase;
});
